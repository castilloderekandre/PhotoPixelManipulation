...
exports.rangeKernel = exports.spatialKernel = void 0;
/**
...
const applyKernels = (grayscaleImageData) => {
    ...
    let spatial_kernel = Array.from({ length: KERNEL_SIZE }, (_, i) => Array.from({ length: KERNEL_SIZE }, (_, j) => (0, exports.spatialKernel)(i - KERNEL_HALF_SIZE, j - KERNEL_HALF_SIZE, 0, 0, SPATIAL_SIGMA)));
        ...
        for (let j = 0; j < grayscaleImageData.width; j++) {
            ...
            for (let window_y = 0; window_y < KERNEL_SIZE /*window size*/; window_y++) {
                for (let window_x = 0; window_x < KERNEL_SIZE /*window size*/; window_x++) {
                    ...
                    const w_p = spatial_kernel[window_y][window_x] * (0, exports.rangeKernel)(window_intensity, anchor_intensity, RANGE_SIGMA);
